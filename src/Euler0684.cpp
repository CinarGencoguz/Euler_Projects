...
long long int mod,result,coefficient,sub,tenpow,invmod,num1;
unsigned long long int fibo[91],digit,remain;
...
int main() 
{
   ...
   for (int i = 2; i <= 90; ++i) 
   {
      ...
      tenpow = Mathutilus::modPow(10, digit,mod); // 10^digit % mod
